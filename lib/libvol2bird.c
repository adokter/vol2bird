...
void writeCSV(char *filename, vol2bird_t* alldata, char* source, char* fileIn, char* date, char* time, PolarVolume_t* pvol){
    ...
    fprintf(fp, "HGHT, datetime, u,v,w,ff,dd,sd_vvp,gap,dbz,eta,dens,DBZH,n,n_dbz,n_all,n_dbz_all,rcs,sd_vvp_threshold,vcp\n");
    ...
    for (iRowProfile = 0; iRowProfile < nRowsProfile; iRowProfile++) {
        ...
        nanify(profileBio[10+iCopied]),(int)nanify(profileBio[13+iCopied]), // n, n_dbz 
